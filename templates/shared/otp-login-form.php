...
$title = $title ?? __( 'Entrar com WhatsApp', 'joinotify-otp-login' );
...
>
    <noscript>
        <div class="rounded-[1.75rem] border border-slate-200 bg-white p-6 text-slate-700 shadow-[0_24px_80px_rgba(15,23,42,0.12)]">
            <?php if ( $show_header ) : ?>
            ...
            <p class="mt-4 text-sm text-slate-500">
                <?php esc_html_e( 'Ative o JavaScript para usar o login com WhatsApp ou e-mail e senha.', 'joinotify-otp-login' ); ?>
            </p>
        </div>
    </noscript>
</div>
