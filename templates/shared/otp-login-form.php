...
<div class="joinotify-otp-login" data-context="<?php echo esc_attr( $context ?? 'myaccount' ); ?>">
    <div class="joinotify-otp-login__header">
        <h2 class="joinotify-otp-login__title"><?php echo esc_html( $title ?? __( 'Sign in with WhatsApp', 'joinotify-otp-login' ) ); ?></h2>
    ...
    <div data-login-step="phone">
        <form class="joinotify-otp-login__form" data-phone-form>
            ...
            <p class="joinotify-otp-login__actions">
                <button type="submit" class="button alt"><?php esc_html_e( 'Receive code', 'joinotify-otp-login' ); ?></button>
                <a href="#" class="joinotify-otp-link" data-switch-step="password"><?php esc_html_e( 'Sign in with email and password', 'joinotify-otp-login' ); ?></a>
            </p>
        </form>
    </div>
        ...
        <form class="joinotify-otp-login__form" data-otp-form>
            ...
            <p class="form-row form-row-wide">
                <label for="joinotify-otp-code-<?php echo esc_attr( $context ?? 'default' ); ?>">
                    <?php esc_html_e( 'OTP code', 'joinotify-otp-login' ); ?>
                    <span class="required" aria-hidden="true">*</span>
                </label>
            ...
            <p class="joinotify-otp-login__actions">
                <button type="submit" class="button alt"><?php esc_html_e( 'Verify code', 'joinotify-otp-login' ); ?></button>
                <a href="#" class="joinotify-otp-link" data-switch-step="phone"><?php esc_html_e( 'Change phone number', 'joinotify-otp-login' ); ?></a>
            </p>
        </form>
    </div>
    ...
    <div data-login-step="password" hidden>
        ...
        <form class="joinotify-otp-login__form" data-password-form>
            ...
            <p class="joinotify-otp-login__actions">
                ...
                <a href="#" class="joinotify-otp-link" data-switch-step="phone"><?php esc_html_e( 'Back to phone', 'joinotify-otp-login' ); ?></a>
            </p>
        </form>
